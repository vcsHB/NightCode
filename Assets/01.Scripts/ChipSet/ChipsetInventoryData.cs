...
namespace Chipset
{
    public class ChipsetInventoryData
    {
        ...
        public ChipsetInventoryData(CharacterEnum character, Vector2Int inventorySize, List<Vector2Int> openSlot, RectTransform chipsetParent)
        {
